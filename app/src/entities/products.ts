...
const cfwDiscordBot: Product = {
  ...
  imgs: ['cfw-discord-bot.png'],
  infras: [Techs.nodejs, Techs.cloudflareWorkers, Techs.gas, Techs.discordApi],
  langs: [Langs.js, Langs.gas],
  body: {
    en: `
...
const portfolio: Product = {
  ...
  imgs: ['portfolio-site.png'],
  infras: [Techs.cloudflarePages, Techs.astro, Techs.tailwind, Techs.react],
  langs: [Langs.ts],
  body: {
    en: `
			This website.
...
const products: Product[] = [cfwDiscordBot, portfolio];
